...
![ipad use at school](https://user-images.githubusercontent.com/42104341/47611312-b9beea80-dab6-11e8-9caa-715b9dfa36c7.JPG)
...
The story of how I had wanted to develop this software began was when I first came into Australia from China, I had arrived at a very young age and hence my English has improved dramatically throughout the years that I have been attending school. I never really thought of generating a type of software or even creating a new device, my interests in technology gradually got the best of me and I wanted to try something new and creative that could benefit not just myself, but every other person who may be going through the same path that I did when I first came to Australia and not knowing any English. Long story short, I wanted to make things easier for people of any age to learn a new language with a simple click of a button, or with a user-friendly application that could be easily integrated into our phones and other hand-held devices, whether it may be at home or at school, it can be easily accessed anywhere around the world. 

Growing up I had learnt that Mobile learning had become more and more integrated into our lives, we are moving away from books and having more interactive based activities at school, I guess this is the direction that majority of the schools are taking as it is what human beings are used to nowadays. We do almost everything online and rarely anything on the books anymore which is rather sad, but this is how we evolve and prepare ourselves for the future. Our world today is obsessed with technology, so I thought why not make it easier for students to self-study on devices that we use on a daily by creating an application that can be used offline and online to enable them to study at a faster and more effective rate that could benefit them and other people for their classes and themselves. 

Coming from primary, secondary and now tertiary study has indefinitely allowed me to discover that we do not have all the time in the world when it comes to deadlines, majority of us choose to study online rather then go through books which would supposedly take longer. Instead, we can use user-friendly applications that can allow students to study on the go and have it all accessible on their devices that they use every day. Hence, EZ English or EZ-E is designed for android-based phones and tablets and will be available on apple products very soon. 

EZ English is an application that contains a wide database filled with different languages that a student may choose to learn, whether it may be for a class or during their own personal time outside of school, the program is designed to be effective and efficient whilst keeping the students busy and entertained at the same time. If they are stuck with any problems on the application then they can simply press the help button and all their solutions can be found within the application, this is with the help of the other users who use the same software and can help one another by inputting their questions and answers out there for everyone else to see. 

All the interactive activities in EZ English can be used both online and offline, although majority of the time people or students will be connected to the internet which makes it a much easier process as the time input when choosing an activity to do or language to learn may differ when using the application whilst it is offline. But, there will not be an issue as we slowly improve our software so that it will become silky-smooth to use and have no issues with software or lag input whilst using any of the functions on the application. 
To begin the project, we have to make sure that the sample size that we give the software and application to are from all different types of backgrounds because in this way we can generate feedback and then use that feedback to see whether the translation progress is accurate enough or not, and if it is not then we can use the students correct way of pronouncing the word and integrate it into our current software for future updates. 

Once we have configured the software which we will be doing by utilising Android Software Development Kit and Android Studios we can begin integrating different types of languages onto the Micro SD card which will be our storage system for the device itself. Having two variations of the EZ-E Block will mean that it can store more or less languages, but the prices of the two items will be different, there will be a 128gb version and a 512gb version, each has the exact same use but only that one is more future-proof in terms of how many languages and updates it can store on the device itself. 

All this will hopefully be done before week 10 as stated in the timetable above, because once week 10 is over we should be able to redefine the device and tweak it so that it becomes more than near perfect and stable for future users. Hopefully this will all be achieved by that week, otherwise more time will have to be spent on the product and software, hence the implementation of the new EZ-Ears will have to be delayed and the process for the project idea will have to be extended for a few more weeks. If all goes to plan, then none of this will happen and we will continue with the EZ-Ears introduction during week 12. 

![translation ear piece](https://user-images.githubusercontent.com/42104341/47611374-ef180800-dab7-11e8-993e-1010ba57ab04.jpg)

Moving onto a Generation of a new item, the EZ-Ears, an in earphone that connects to your phone and is able to translate videos that are played in different languages or voices. The implementation of this new piece of technology is actually because of an idea that I had thought of quite a while ago. The idea was to create an ear piece that could also be integrated into elderly’s hearing aids that can help improve their hearing but at the same time be able to translate on the spot what other people may be saying when they are communicating with random people from another language. The EZ-Ears is not only designed for the elderly but also designed for people who wish to watch other videos that may not be their first language but do not like the use of subtitles and would much prefer direct translation via the ears. In another sense, this is kind of like switching the audio of the video or voice into English or any specified language that you prefer to listen in. 

Trying to implement the hearing aid and language translator on the same hearing device will be quite the challenge but it is not impossible either, with much careful research and careful design of the product, this could rather be useful to many people and could be the next big thing in rising technology. If all goes to plan, we will perfect the EZ-Ears and its software in hopes to advertise it worldwide and showcase it to other companies in hopes to gain an opportunity in partnership, this will be a very big move for Simple Tech and could become the start of something new. 

EZ-E Blocks will be a major implementation into our society and especially for people who travel, we hope that many individuals will seek to use the block as it is designed to help people communicate worldwide with each other and could be deemed as a very useful device for just about anyone who might be afraid of travelling. EZ-Ears may not be as popular as the EZ-E Block but it may be popular for the community of the elderly, especially for those who enjoy socialising and want to be able to understand the people that they talk to without having to talk in a language that they don’t know how to speak in, they can have it directly translated to their ears.

Simple Tech wishes to embark on expanding their business and will continue to do so by continuously updating our products and software, our major goal will always be to help others and making their language learning a much easier and interactive process as our number one goal. Simple Tech will continue to provide for the community and continue to output more interesting devices that are aimed towards the future of our generation. 
...
![business risk](https://user-images.githubusercontent.com/42104341/47611383-2090d380-dab8-11e8-93d2-898bf3df630a.jpg)
